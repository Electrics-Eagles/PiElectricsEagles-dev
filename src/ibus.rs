...
let mut uart_mod: Uart;

/* Initialize IBUS receiver */
pub fn initialiize() {
  uart_mod = Uart::new(115_200, Parity::None, 8, 1).unwrap();
  uart_mod.set_read_mode(40, Duration::default()).unwrap();
}
/* Function for getting data of ibus receiver */
pub fn get_datas_of_channel_form_ibus_receiver() -> type_of_data_from_channels {
