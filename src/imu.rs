...
use mpu6050::device::{AccelRange, GyroRange, ACCEL_HPF, ACC_REGX_H, GYRO_REGX_H};
    ...
    pub fn get_normalised_gyro_data(&mut self, swapping: String, reverse: String) -> ImuData {
        ...
        unsafe {
            if loop_of_calib == 2000 {
                ...
                let reversed_data =
                    self.reverse(reverse, swapped_data.0, swapped_data.1, swapped_data.2);
                return ImuData {
