...
impl Controller {
    ...
    /// # Arguments
    ///
    /// channel: selecting channel of motor
    ///
    /// pwm_duty: pulse to run motor
    ///
    /// All values of channels are range from 1000 - 2000 us
    ///
    /// 1000 - slowest speed of running esc
    ...
    /// 2000 - maximun speed of running esc
    ///
    /// You can select channel by enumaration from pwm_pca9685.
    ///
    /// ```
    /// - pwm_pca9685::Channel::C0 // first motor
    /// - pwm_pca9685::Channel::C1 // second motor
    /// - pwm_pca9685::Channel::C2 // third motor
    /// - pwm_pca9685::Channel::C3 // fourth motor
    /// ```
    ///
    /// # Examples
    /// **** Already added to loggics file. Be careful. Editing code can break stability of devices. *****
    ...
    /// ```
    ///
    pub fn run_single_motor(&mut self, channel: Channel, pwm_duty: u16) {
        let value_pwm = map(pwm_duty as i64, 0, 20000, 0, 4095) as u16;
        self.pwm.set_channel_on_off(channel, 0, value_pwm).unwrap();
    }
}
